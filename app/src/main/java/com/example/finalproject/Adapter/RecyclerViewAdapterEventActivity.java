...
public class RecyclerViewAdapterEventActivity extends RecyclerView.Adapter<RecyclerViewAdapterEventActivity.ViewHolder> {

    private Context context;
    private List<Event> eventList;

    public RecyclerViewAdapterEventActivity(Context context, List<Event> eventList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_row_activity,parent,false);
